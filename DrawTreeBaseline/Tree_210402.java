 ...
 * @since 2019-11-26
 */
public class Tree_210402 extends LandscapeObject{
	//Attributes
	 ...
	 * @return	void
	 */
	public Tree_210402(Graphics2D g2, int x, int y, double scale, int levels,  String s_trunkColor, String s_branchColor, String shape) {
		super(g2, x, y, scale);
		this.levels = levels;
	...
	public void applyScale() {
		trunkWidth = trunkWidth * 2;
		trunkHeight = trunkHeight * 2;
		branchWidth = branchWidth * 3;
		branchHeight = branchHeight * 2;
		branchOverlap = branchOverlap * 2; 
	...
	private void drawTrunk() {
		...
		//g2.draw(new Rectangle2D.Float(100, 400, trunkHeight, trunkWidth));
		g2.fillRect(100, 400, trunkHeight, trunkWidth);
		g2.fillRect(190, 375, trunkHeight, trunkWidth);
		g2.fillRect(290, 450, trunkHeight, trunkWidth);
		g2.fillRect(1200, 450, trunkHeight, trunkWidth);
		g2.fillRect(1300, 400, trunkHeight, trunkWidth);
		g2.fillRect(1400, 500, trunkHeight, trunkWidth);
