 ...
 * @since 2019-11-16
 */
public final class PGame_210312 extends JPanel {
	...
	public static void run(PDeck deck, PHand dealer, PHand player) {
		final PGame_210312 game = new PGame_210312(deck, dealer, player);
	...
	private static String GAME_FONT = "TimesNewRoman";
	private PDeck deck;
	...
	public PGame_210312(PDeck deck, PHand dealer, PHand player) {
		this.deck = deck;
		this.dealer = dealer;
		this.player = player;
